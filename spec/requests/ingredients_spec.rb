...
RSpec.describe 'api/v1/ingredients', type: :request do
  ...
  describe 'GET /index' do
    it 'renders a successful response' do
      ...
      get api_v1_ingredients_url, headers: valid_headers, as: :json
  ...
  describe 'GET /show' do
    it 'renders a successful response' do
      ...
      get api_v1_ingredient_url(ingredient), as: :json
      expect(response).to be_successful
    end
  end
  ...
  describe 'DELETE /destroy' do
    it 'destroys the requested ingredient' do
      ingredient = Ingredient.create! valid_attributes
      expect do
        delete api_v1_ingredient_url(ingredient), headers: valid_headers, as: :json
      end.to change(Ingredient, :count).by(-1)
    end
  end
end
